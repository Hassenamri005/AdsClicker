            ...
            <div class="col-sm-5" style="margin: auto;border: 1px solid rgb(224, 221, 221); border-radius: 5px;padding: 10px;">
                <form>
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Website Title" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <b><label for="exampleFormControlTextarea1">Short Description</label>
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Your website description" required></textarea>                    
                    </div>
                    <br>
                    <div class="form-group">
                        <b><label for="exampleInputEmail1">Url</label></b>
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Your website URL" required>
                    </div>
                    <br>
                    <div class="form-group">
                        <b><label for="exampleInputEmail1">Click Price</label></b>
                        <input type="number" class="form-control" value="0.01" min="0.01" max="2" step="0.01" id="exampleInputEmail1" aria-describedby="emailHelp" required>
                    </div>
                    <br>
