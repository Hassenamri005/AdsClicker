    ...
    <header class="navbar navbar-dark sticky-top flex-md-nowrap p-0 shadow">
        ...
        <div class="navbar-nav col-md-3 col-lg-1">
            <div class="nav-item text-nowrap text-center right-nav">
                ...
                <a class="nav-link right-nav" style="color: #fff;"href="{{ route('logout') }}"
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                            ...
                            <div class="col-sm-4">
                                <div class="card mb-4 rounded-3" style="border-radius: 20px;">
                                    ...
                                    <div class="card-body text-center" style="background-color: #ffa801; color: #fff;">
                                        <h1 class="card-title pricing-card-title">{{$nbUsers}}<small
                                                style="color: #fff; font-size: medium;">/account</small></h1>
                            ...
                            <div class="col-sm-4 " style="border-radius: 20px;">
                                <div class="card mb-4 rounded-3 " style="border-radius: 20px;">
                                    <div class="card-header py-3 text-white bg-primary ">
                                        <h4 class="my-0 fw-normal">Clicks</h4>
                                    </div>
                                    <div class="card-body text-center" style="background-color: #0d6efd; color: #fff;">
                                        <h1 class="card-title pricing-card-title">66825</h1>
                ...
                <div class="my-ads-section" id="my-ads-section">
                    <h2>Ads</h2>
                    <hr>
                    <h5 class="btn btn-outline-primary">Pending Ads</h5>
                    <br>
                    <div class="row">
                        @foreach ($penAds as $ad)
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm">
                                    <svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                                        ...
                                        <rect fill="#55595c" width="100%" height="100%" /><text fill="#eceeef" dy=".3em"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="btn-group">
                                                <a href="/admin/ad-details/{{$ad->id}}" class="btn btn-sm btn-outline-success">Publish</a>
                                                <a href="/admin/delete-ad/{{$ad->id}}" class="btn btn-sm btn-danger">Delete</a>
                                            </div>
                    ...
                    <hr>
                    <h5 class="btn btn-outline-success">Published Ads</h5>
                    <br>
                    <div class="row">
                        @foreach ($ads as $ad)
                            <div class="col-md-4">
                                <div class="card mb-4 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <small class="text-muted">{{$ad->price}}</small>
                                            <div class="btn-group">
                                                <a href="/admin/ad-details/{{$ad->id}}" class="btn btn-sm btn-outline-success">Details</a>
                                                <a href="/admin/delete-ad/{{$ad->id}}" class="btn btn-sm btn-danger">Delete</a>
                                            </div>
                        ...
                        <ul class="list-group list-group-flush">
                            @foreach ($users as $user)
                                <li class="list-group-item" style="width: 100%; display: flex;">
                                    <div class="avatar" style="width: 80%;">
                                        <a href=""><img src="" alt="" width="40" height="40" style="border: 1px solid red; border-radius: 50%;"></a>
                                        <a href="" style="text-decoration: none; color: black;"><b>{{$user->name}}</b></a>
                                    </div>
                                    <div class="operation" style="width: 20%;">
                                        <a href="/admin/{{$user->id}}/user-details" class="btn btn-outline-success">Details</a>                              
                                        <a href="/admin/{{$user->id}}/delete-user" class="btn btn-outline-danger">Delete</a>
                                    </div>                               
                                </li>
                            @endforeach
